...
export default function SettingsPage() {
  ...
  const [autoApproveThreshold, setAutoApproveThreshold] = useState('medium')
    ...
    <div className="p-6 space-y-6 max-w-2xl">
      ...
      <section className="space-y-3">
        ...
        <Card className="space-y-5">
          ...
          <div>
            <label className="text-xs font-medium text-zinc-400 block mb-2">Auto-approve Confidence Threshold</label>
            <select
            ...
            >
              <option value="high">High (95%+) — rarely auto-approves</option>
              <option value="medium">Medium (80%+) — balanced</option>
              <option value="low">Low (60%+) — auto-approves often</option>
            </select>
          </div>
          ...
          <div className="space-y-2.5">
            {[
              { label: 'Run security audit before each commit' },
              { label: 'Auto-create GitHub PRs after successful runs' },
